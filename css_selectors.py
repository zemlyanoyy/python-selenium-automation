...
# By class
driver.find_element(By.CSS_SELECTOR, '.icp-nav-flag-us') # If one class will be enoygh to find element
driver.find_element(By.CSS_SELECTOR, '.icp-nav-flag-us.icp-nav-flag') # If we need two or more classes
...
driver.find_element(By.CSS_SELECTOR, "#lagalTextRow [href*='condition']")
